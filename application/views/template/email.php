    ...
    <div class="container">
			...
			<table style="border: none;">
				<tr style="border: none;">
					<td style="border: none;">
						<img src="<?php echo $company_logo; ?>"></img>
					</td>
					<td style="border: none;">
						<h1></h1>
					</td> 
		...
		<div class="content" style="overflow-x:auto;">			
			<table class="" style="border: none;">
			  <tr style="background-color: #ebeef2; border: none;">
				<td style="text-align: left;border: none;">
					<font size="2" >
					From:<br>
					<?php echo $company_name; ?>.<br>
					<?php echo $company_address; ?><br>
					Phone: <?php echo $company_contact; ?><br>
				...
				<td style="text-align: left; border: none;">
					...
					Date: <?php echo $created_date; ?><br>	
					Order ID: <?php echo $order_no; ?><br>
					Status: <?php echo $status; ?>
					</font>
				</td>
				<td style="border: none;">
					<img src="<?php echo $qrCode; ?>"></img>
				</td>
			  </tr>
			</table>
		</div>
		...
		<div class="content" style="text-align: left;">
			...
			<p>*Please Scan QR Code view and feedback us within 7 days.</p>
		<div>
		<br>
